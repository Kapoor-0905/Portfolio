...
final Details quickcare = Details(
  ...
  projectAssets: [
    "assets/images/quickcare/1.png",
    "assets/images/quickcare/2.png",
    "assets/images/quickcare/3.png",
    "assets/images/quickcare/4.png",
    "assets/images/quickcare/5.png",
  ],
...
final Details musclegrm = Details(
  ...
  projectAssets: [
    "assets/images/musclegrm/1.png",
    "assets/images/musclegrm/2.png",
    "assets/images/musclegrm/3.png",
    "assets/images/musclegrm/4.png",
    "assets/images/musclegrm/5.png",
  ],
...
final Details curiosify = Details(
  ...
  projectAssets: [
    "assets/images/curiosify/1.webp",
    "assets/images/curiosify/2.webp",
    "assets/images/curiosify/3.webp",
    "assets/images/curiosify/4.webp",
    "assets/images/curiosify/5.webp",
    "assets/images/curiosify/6.webp",
...
final Details jancare = Details(
  ...
  projectDescription: "",
  projectAssets: [
    "assets/images/jancare/1.png",
    "assets/images/jancare/2.png",
    "assets/images/jancare/3.png",
    "assets/images/jancare/4.png",
  ],
