...
import 'appCoreTheme.dart';

class AppTheme {
  static final _core = AppCoreTheme(
    shadowSub: Color.fromARGB(255, 13, 224, 214).withAlpha(100),
    primary: const Color.fromARGB(255, 13, 224, 214),
    primaryLight: const Color.fromARGB(255, 13, 224, 214).withAlpha(100),
